...
ROMTITLE    	:=  LinkUni
ROMCODE     	:=  LINK
USERFLAGS   	:=  -Ofast -Wno-unused-parameter -DLINK_WIRELESS_MAX_SERVER_TRANSFER_LENGTH=6 -DLINK_WIRELESS_PUT_ISR_IN_IWRAM=1 -DLINK_WIRELESS_ENABLE_NESTED_IRQ=1 -DLINK_WIRELESS_MULTIBOOT_ASYNC_LIMIT_TRANSFER_SPEED=1
USERCXXFLAGS	:=  
USERASFLAGS 	:=  
