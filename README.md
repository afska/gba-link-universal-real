...
The example sets the interval at around ~4 transfers per frame and sends 3 consecutive numbers on each frame. Each node validates that the numbers are consecutive, ensuring there are no repeated or missed packets.
